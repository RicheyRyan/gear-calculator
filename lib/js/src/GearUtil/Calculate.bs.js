...
var Unit$ReactTemplate = require("../Unit.bs.js");

function isEvenFloat(x) {
  return x % 2.0 === 0.0;
}

var partial_arg = Unit$ReactTemplate.Distance[/* convert */7];

function metreToKm(param) {
  return partial_arg(/* Metre */3, /* Km */4, param);
}

var partial_arg$1 = Unit$ReactTemplate.Distance[/* convert */7];

function metreToMile(param) {
  return partial_arg$1(/* Metre */3, /* Mile */5, param);
}

var partial_arg$2 = Unit$ReactTemplate.Distance[/* convert */7];

function inchToMetre(param) {
  return partial_arg$2(/* Inch */2, /* Metre */3, param);
}

var partial_arg$3 = Unit$ReactTemplate.Distance[/* convert */7];

function mmToInch(param) {
  return partial_arg$3(/* Mm */0, /* Inch */2, param);
}

var partial_arg$4 = Unit$ReactTemplate.Time[/* convert */8];
